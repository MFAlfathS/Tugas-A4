...
function showAddHeroModal() {
    $('#add-hero-form')[0].reset(); // Reset form before showing the modal
    $('#add-hero-form').off('submit'); // Remove any previous event listener
    $('#add-hero-form').on('submit', addHero); // Add event listener for adding a new hero
